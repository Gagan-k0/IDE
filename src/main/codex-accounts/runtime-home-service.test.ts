...
describe('CodexRuntimeHomeService', () => {
  ...
  it('returns the LogicMantra-managed runtime home for Codex launch and rate-limit preparation', async () => {
  ...
  it('resolves only LogicMantra-owned homes used by live retained host shells', async () => {
