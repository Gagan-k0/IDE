...
describe('registerPtyHandlers', () => {
  ...
  describe('spawn environment', () => {
    it('refreshes the outer Windows PATH for a WSL spawn without forwarding it', async () => {
      ...
      try {
        ...
        await provider.spawn({
          ...
          env: {
            PATH: 'C:\\LogicMantra\\bin;C:\\Users\\me\\AppData\\Local\\Microsoft\\WindowsApps',
        ...
        expect(options.env.PATH).toBe(
          'C:\\LogicMantra\\bin;C:\\Windows\\System32;C:\\Python314;C:\\Users\\me\\AppData\\Local\\Microsoft\\WindowsApps'
        )
    ...
    it('always sets TERM and COLORTERM regardless of env', async () => {
      ...
      expect(env.TERM_PROGRAM).toBe('LogicMantra')
    })
    ...
    it('injects the selected Codex home into LogicMantra terminal PTYs', async () => {
    ...
    describe('unverifiable Codex resume provenance', () => {
      ...
      posixOnlyIt(
        'launches plain codex when a REAL rollout sits under a home LogicMantra no longer trusts',
        async () => {
    ...
    it('injects the OpenCode hook env into LogicMantra terminal PTYs', async () => {
    ...
    it('mirrors the original OpenCode source dir when launched from a LogicMantra overlay shell', async () => {
      const env = await spawnAndGetEnv({
    ...
    it('does not treat inherited LogicMantra OpenCode config as user config without a source dir', async () => {
      const env = await spawnAndGetEnv({
        OPENCODE_CONFIG_DIR: '/tmp/parent-orca-opencode-overlay',
    ...
    it('restores user OpenCode config when agent status hooks are disabled in a nested LogicMantra shell', async () => {
      const env = await spawnAndGetEnv(
        {
          OPENCODE_CONFIG_DIR: '/tmp/parent-orca-opencode-overlay',
          ORCA_OPENCODE_CONFIG_DIR: '/tmp/parent-orca-opencode-overlay',
    ...
    it('restores user MiMo home when agent status hooks are disabled in a nested LogicMantra shell', async () => {
      const env = await spawnAndGetEnv(
        {
    ...
    posixOnlyIt(
      'reproduces issue #1534: GUI-launched LogicMantra mirrors zshrc-only OpenCode config',
      async () => {
    ...
    it('installs Pi managed extensions without redirecting LogicMantra terminal PTY homes', async () => {
    ...
    it('mirrors the original Pi source dir when launched from a LogicMantra overlay shell', async () => {
      const env = await spawnAndGetEnv({
    ...
    it('restores user Pi config when agent status hooks are disabled in a nested LogicMantra shell', async () => {
      const env = await spawnAndGetEnv(
        {
          PI_CODING_AGENT_DIR: '/tmp/parent-orca-pi-overlay',
          ORCA_PI_CODING_AGENT_DIR: '/tmp/parent-orca-pi-overlay',
    ...
    it('injects the agent hook receiver env into LogicMantra terminal PTYs', async () => {
      const env = await spawnAndGetEnv()
    ...
    it('overrides ambient CODEX_HOME with the LogicMantra-managed home for system default', async () => {
      const env = await spawnAndGetEnv(
        undefined,
    ...
    describe('daemon-active provider (parity with LocalPtyProvider)', () => {
      ...
      it('skips host Codex home when a daemon-backed Windows spawn targets a WSL cwd', async () => {
        ...
        try {
          const spawnOptions = await daemonSpawnAndGetOptions(
            {},
            () => 'C:\\Users\\test\\AppData\\Roaming\\LogicMantra\\codex-runtime-home\\home',
            undefined,
            {
              CODEX_HOME: 'C:\\Users\\test\\AppData\\Roaming\\LogicMantra\\codex-runtime-home\\home',
              ORCA_CODEX_HOME: 'C:\\Users\\test\\AppData\\Roaming\\LogicMantra\\codex-runtime-home\\home'
            },
            {
      ...
      it('strips the daemon-inherited LogicMantra-owned CODEX_HOME for real-home routing', async () => {
        const spawnOptions = await daemonSpawnAndGetOptions(
          {},
          () => null,
          () => ({ codexSystemDefaultRealHomeEnabled: true }) as never,
  ...
  it('forwards the trusted LogicMantra terminal handle into managed WSL terminals', async () => {
    const platform = Object.getOwnPropertyDescriptor(process, 'platform')
    Object.defineProperty(process, 'platform', {
      configurable: true,
      value: 'win32'
