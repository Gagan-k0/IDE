...
describe('PiTitlebarExtensionService', () => {
  ...
  it('buildPtyEnv installs LogicMantra extensions into the user agent dir without redirecting the home', () => {
  ...
  it('rebuilding updates LogicMantra-owned extensions while preserving user files', () => {
    const svc = new PiTitlebarExtensionService()
  ...
  it("does not overwrite a user's same-named LogicMantra extension file", () => {
  ...
  it('uses a LogicMantra-owned OMP status extension when a same-named user file exists', () => {
    const userStatusExtension = 'user-owned status extension'
