...
describe('isOrcaAttributedPrompt', () => {
  it('accepts the app and detached terminal helper across LogicMantra build identities', () => {
    for (const id of [
      'com.stablyai.orca',
  ...
  it('rejects unrelated services even when LogicMantra is responsible', () => {
    expect(
      isOrcaAttributedPrompt({
...
describe('MacosTccPromptWatch', () => {
  ...
  it('reports only LogicMantra-attributed dialogs from a live stream', async () => {
