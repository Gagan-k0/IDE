...
describe('browserManager', () => {
  ...
  it('keeps plain links current and routes explicit new-tab gestures to LogicMantra tabs', async () => {
    const rendererSendMock = vi.fn()
  ...
  it('does not focus the LogicMantra window while preparing a screenshot', async () => {
  ...
  it('offers opening a link in another LogicMantra browser tab from the guest context menu', () => {
    const rendererSendMock = vi.fn()
    const guest = {
      id: 104,
      isDestroyed: vi.fn(() => false),
