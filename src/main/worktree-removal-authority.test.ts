...
describe('canCleanupUnregisteredOrcaWorktreeDirectory', () => {
  ...
  it('accepts legacy LogicMantra-created metadata before explicit provenance existed', () => {
    expect(
      canCleanupUnregisteredOrcaWorktreeDirectory({
...
describe('stripOrcaProvenanceMetaUpdates', () => {
  it('removes LogicMantra-owned provenance fields from user metadata updates', () => {
    expect(
      stripOrcaProvenanceMetaUpdates({
        comment: 'keep me',
        orcaCreatedAt: 123,
