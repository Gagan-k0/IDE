...
describe('upsertHookTrustEntries', () => {
  ...
  it('finds and replaces a legacy forward-slash block when LogicMantra upserts with native backslash key', () => {
  ...
  it('finds a Codex-written block with lowercased username when LogicMantra key has mixed-case username', () => {
