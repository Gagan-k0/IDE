...
describe('addOrcaWslInteropEnv', () => {
  it('marks the LogicMantra terminal handle for Windows to WSL env import', () => {
  ...
  it('marks OMP status and hook env for Windows to WSL import', () => {
    const env: Record<string, string> = {
      ...
      ORCA_USER_DATA_PATH: 'C:\\Users\\jin\\AppData\\Roaming\\LogicMantra',
  ...
  it('path-translates a Windows hook endpoint but passes a guest-side one untouched', () => {
    const windowsEnv: Record<string, string> = {
      ORCA_AGENT_HOOK_ENDPOINT: 'C:\\Users\\jin\\AppData\\Roaming\\LogicMantra\\agent-hooks\\endpoint.cmd'
    }
  ...
  it('never crosses a Windows OpenCode config dir into the guest', () => {
    ...
    const env: Record<string, string> = {
      OPENCODE_CONFIG_DIR: 'C:\\Users\\jin\\AppData\\Roaming\\LogicMantra\\opencode-overlays\\abc',
      ORCA_OPENCODE_CONFIG_DIR: 'C:\\Users\\jin\\AppData\\Roaming\\LogicMantra\\opencode-overlays\\abc'
    }
    addOrcaWslInteropEnv(env)
