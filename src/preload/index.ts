...
const api = {
  ...
  baton: {
    getAvailability: (): Promise<BatonAvailability> => ipcRenderer.invoke('baton:getAvailability'),
    setup: (folderPath: string): Promise<BatonSetupResult> =>
      ipcRenderer.invoke('baton:setup', folderPath),
    getDaemonStatus: (): Promise<BatonDaemonStatus> =>
      ipcRenderer.invoke('baton:getDaemonStatus'),
    startDaemon: (folderPath: string): Promise<BatonDaemonStatus> =>
      ipcRenderer.invoke('baton:startDaemon', folderPath),
