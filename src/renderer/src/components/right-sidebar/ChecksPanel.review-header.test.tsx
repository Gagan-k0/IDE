...
describe('ChecksPanelReviewHeader', () => {
  ...
  it('names LogicMantra when the modifier inverts toward the built-in browser', () => {
    expect(renderHeader({ modifierHintDestination: 'orca' })).toContain('⇧⌘+click to open in LogicMantra')

    vi.stubGlobal('navigator', { userAgent: 'Windows' })
    expect(renderHeader({ modifierHintDestination: 'orca' })).toContain(
      'Shift+Ctrl+click to open in LogicMantra'
    )
  })
