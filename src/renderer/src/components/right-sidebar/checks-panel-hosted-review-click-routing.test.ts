...
describe('checks panel hosted review modifier hint destination', () => {
  it('names the system browser when a plain click already opens in LogicMantra', () => {
  ...
  it('names the system browser when inverting is on and links already open in LogicMantra', () => {
    expect(
      resolveChecksPanelHostedReviewModifierDestination(
  ...
  it('names LogicMantra when inverting is on and links open externally', () => {
    expect(
      resolveChecksPanelHostedReviewModifierDestination(
