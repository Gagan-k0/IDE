...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when LogicMantra Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove LogicMantra Mobile')
  })

  it('labels the restore action explicitly when LogicMantra Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
