  ...
  const segment = running
    ? {
        ...
        tooltip: translate(
          ...
          'Remote LogicMantra Server updates are in progress'
        )
      }
    : failed > 0
      ? {
          ...
          tooltip: translate(
            ...
            'Open Remote LogicMantra Server updates to review and retry'
          )
        }
      : {
          ...
          tooltip: translate(
            ...
            'Remote LogicMantra Server updates completed'
          )
        }
