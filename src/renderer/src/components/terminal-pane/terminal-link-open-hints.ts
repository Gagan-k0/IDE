...
export function getTerminalOrcaFileOpenHint(showActions = true): string {
  ...
  return isMacPlatform()
    ? `${prefix}⌘+click to open in LogicMantra`
    : `${prefix}Ctrl+click to open in LogicMantra`
}
...
export function getTerminalUrlOpenHint(options: TerminalUrlOpenHintOptions = {}): string {
  ...
  if (invertsToOrca) {
    return isMacPlatform()
      ? `${prefix}⌘+click to open, or ⇧⌘+click to open in LogicMantra`
      : `${prefix}Ctrl+click to open, or Shift+Ctrl+click to open in LogicMantra`
  }
  return isMacPlatform()
...
export function getTerminalUrlOrcaBrowserHint(): string {
  return isMacPlatform() ? '⇧⌘+click to open in LogicMantra' : 'Shift+Ctrl+click to open in LogicMantra'
}
