...
describe('terminal link action routing', () => {
  ...
  it('offers system browser first and LogicMantra second when system browser is the default', () => {
    const request = vi.fn()
    ...
    expect(request.mock.calls[0][0].alternate.label).toBe('LogicMantra Browser')
  ...
  it('offers LogicMantra first and system browser second when LogicMantra is the default', () => {
    const request = vi.fn()
    ...
    expect(request.mock.calls[0][0].primary.label).toBe('LogicMantra Browser')
  ...
  it('routes an explicit LogicMantra Browser action to the owning runtime', () => {
    const request = vi.fn()
