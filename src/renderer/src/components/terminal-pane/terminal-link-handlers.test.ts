...
describe('handleOscLink', () => {
  ...
  it('uses the system browser for shift+cmd/ctrl+click even when LogicMantra browser tabs are enabled', () => {
    setPlatform('Windows')
    storeState.settings = { openLinksInApp: true }
  ...
  it('opens local .html file paths in LogicMantra browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('also opens local .htm paths in LogicMantra browser tabs with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file paths in LogicMantra and reveals default column 1 with the platform modifier', async () => {
    setPlatform('Macintosh')
  ...
  it('preserves explicit column for LogicMantra opens from :line:column links', async () => {
    setPlatform('Macintosh')
  ...
  it('falls back to LogicMantra when shift+cmd/ctrl-click system default open fails', async () => {
    setPlatform('Macintosh')
  ...
  it('opens local file URL links in LogicMantra with the platform modifier on desktop', async () => {
    setPlatform('Windows')
  ...
  it('opens #L file URL links in LogicMantra and preserves anchors', async () => {
    setPlatform('Macintosh')
  ...
  it('opens SSH file links through LogicMantra without local authorization', async () => {
    setPlatform('Macintosh')
  ...
  it('ignores stale async completion so latest local click wins for LogicMantra open and reveal', async () => {
    setPlatform('Macintosh')
...
describe('createFilePathLinkProvider range bounds', () => {
  ...
  it('shows the LogicMantra plus default-app hint for local file link hover', async () => {
    setPlatform('Macintosh')
  ...
  it('shows the LogicMantra hint for SSH file link hover', async () => {
    setPlatform('Macintosh')
    vi.mocked(getConnectionId).mockReturnValue('ssh-1')
    const { provider, linkTooltip } = createProviderSetup([makeBufferLine('CLAUDE.md')])
    ...
    expect(linkTooltip.textContent).toBe(
      '/repo/CLAUDE.md (Click for actions or ⌘+click to open in LogicMantra)'
    )
  })
