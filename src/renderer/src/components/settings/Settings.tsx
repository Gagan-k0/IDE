              ...
              <ActiveSettingsSectionProvider value={activeSectionId}>
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Optional. LogicMantra works with your existing provider logins; add accounts only if you want LogicMantra to help switch between them.'
                  )}
                  badge={translate(
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Coordinate multiple coding agents through LogicMantra.'
                  )}
                ...
                <SettingsSection
                  id="baton"
                  title={translate(
                    'auto.components.settings.Settings.batonTitle',
                    'Baton'
                  )}
                  description={translate(
                    'auto.components.settings.Settings.batonDescription',
                ...
                {linearConnected ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'How Linear works in LogicMantra, setup checklist, agent skill, and example prompts.'
                    )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    id="orca-account"
                    title={translate('auto.components.settings.orcaAccount.title', 'LogicMantra Account')}
                    description={translate(
                      'auto.components.settings.orcaAccount.description',
                      'Share work instantly and reach your desktop from LogicMantra Mobile wherever you are.'
                    )}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'Finish the core workflows that make LogicMantra useful for parallel agent work.'
                  )}
                ...
                {showDesktopOnlySettings ? (
                  <SettingsSection
                    ...
                    description={translate(
                      ...
                      'Configure mobile emulator support for LogicMantra and coding agents.'
                    )}
                ...
                <SettingsSection
                  ...
                  description={translate(
                    ...
                    'LogicMantra stats plus Claude, Codex, OpenCode token analytics and Grok subscription usage.'
                  )}
                  ...
                  description={
                    isWebClient
                      ? translate(
                          ...
                          'Connect this browser to a saved LogicMantra server.'
                        )
                      : translate(
                          'auto.components.settings.Settings.b5ee17826b',
                          'Pair remote LogicMantra runtimes for persistent sessions, richer remote state, and web or mobile handoff.'
                        )
                  }
