    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install LogicMantra Mobile from the'
            )}{' '}
            <button
              type="button"
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show LogicMantra Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the LogicMantra Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the LogicMantra Mobile shortcut in the sidebar.'
          )}
