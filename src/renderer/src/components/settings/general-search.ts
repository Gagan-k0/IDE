...
export const getGeneralCliSearchEntries = createLocalizedCatalog(() => [
  {
    title: translate('auto.components.settings.general.search.327e3fa70d', 'LogicMantra CLI'),
    description: translate(
      'auto.components.settings.general.search.ca529079bf',
      'Register or remove the LogicMantra CLI command.'
    ),
    keywords: [
  ...
  },
  {
    ...
    description: translate(
      ...
      'Install the LogicMantra skill so agents know to use the LogicMantra CLI.'
    ),
    keywords: [
...
export const getGeneralUpdateSearchEntries = createLocalizedCatalog(() => [
  {
    ...
    description: translate(
      ...
      'Check for app updates and install a newer LogicMantra version.'
    ),
    keywords: [
