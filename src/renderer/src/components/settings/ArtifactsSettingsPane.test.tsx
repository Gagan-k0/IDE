...
describe('ArtifactsSettingsPane', () => {
  ...
  it('explains the complete sharing workflow', () => {
    ...
    expect(screen.getByText('Manage it in LogicMantra')).toBeInTheDocument()
    expect(
    ...
    expect(screen.queryByText('LogicMantra account')).not.toBeInTheDocument()
    expect(screen.queryByRole('button', { name: 'Sign in to LogicMantra' })).not.toBeInTheDocument()
  })
  ...
  it('offers sign in for a local profile', async () => {
    ...
    await user.click(screen.getByRole('button', { name: 'Sign in to LogicMantra' }))
  ...
  it('loads missing account status and disables sign in until configured', () => {
    ...
    expect(screen.getByRole('button', { name: 'Sign in to LogicMantra' })).toBeDisabled()
  })
