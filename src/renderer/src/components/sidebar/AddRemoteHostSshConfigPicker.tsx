      ...
      <DialogHeader className="text-left">
        ...
        <DialogDescription>
          {translate(
            ...
            'Pick a host to fill the form, or add every new host to LogicMantra’s host list.'
          )}
        </DialogDescription>
      </DialogHeader>
