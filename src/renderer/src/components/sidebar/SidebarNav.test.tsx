...
describe('SidebarNav', () => {
  ...
  it('updates localized labels when the language changes after mount', async () => {
    ...
    expect(queryButtonByText(container, 'LogicMantra Mobile')).not.toBeNull()
    ...
    expect(queryButtonByText(container, 'LogicMantra 手机端')).not.toBeNull()
  })
  ...
  it('shows the inline hide control only once a device is paired', async () => {
    ...
    expect(queryButtonByText(beforePairing, 'LogicMantra Mobile')).not.toBeNull()
  ...
  it('hides Mobile from its sidebar context menu', async () => {
    ...
    const mobileMenu = getButtonByText(container, 'LogicMantra Mobile').closest(
      '[data-testid="context-menu"]'
    )
