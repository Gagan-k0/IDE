...
export function HostRemoveDialog({
  ...
  const description =
    target.kind === 'runtime'
      ? translate(
          ...
          'This opens the LogicMantra servers settings where you can remove this server.'
        )
      : hasWorkspaces
        ? translate(
            'auto.components.sidebar.HostRemoveDialog.hostHasWorkspacesDefault',
            'Removes {{value0}} and its credentials from this computer. Its {{value1}} stay in LogicMantra — remote files are not touched.',
  ...
  const deleteOptionLabel = isConnected
    ...
    : translate(
        ...
        'Also remove these {{value0}} from LogicMantra',
                    ...
                    <span className="mt-0.5 block text-muted-foreground">
                      {isConnected
                        ...
                        : translate(
                            ...
                            'Clears them from LogicMantra only. Remote files, worktrees, and branches are left untouched.'
                          )}
                    </span>
                  </span>
                </div>
