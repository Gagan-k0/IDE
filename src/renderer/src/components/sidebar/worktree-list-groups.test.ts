...
describe('buildRows with pinned worktrees', () => {
  ...
  it('groups multiple host setups for the same project under one project header', () => {
    ...
    expect(rows).toMatchObject([
      { type: 'header', key: 'project:github:stablyai/orca', label: 'LogicMantra', count: 2 },
  ...
  it('shows distinct LogicMantra server names when status grouping mixes runtime hosts', () => {
