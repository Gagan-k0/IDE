    ...
    <UsageTrackingPaneShell
      ...
      filterSections={[
        <UsageFilterRadioGroup
          ...
          value="orca"
          options={[
            { value: 'orca', label: 'LogicMantra worktrees only' },
      ...
      selectionSummary="LogicMantra worktrees only • Last 7 days"
...
describe('UsageTrackingPaneShell', () => {
  ...
  it('renders the empty state and wires header actions', async () => {
    ...
    expect(screen.getByText('LogicMantra worktrees only • Last 7 days')).toBeInTheDocument()
