...
describe('OnboardingFlow', () => {
  ...
  it('does not render the removed agent setup or tour steps', () => {
    ...
    expect(html).not.toContain('Set up LogicMantra for agents')
    expect(html).not.toContain('Explore LogicMantra')
    expect(html).not.toContain('Take the tour')
    expect(html).toContain('Add your first project')
    expect(html).not.toContain('Point LogicMantra at some code')
  })
