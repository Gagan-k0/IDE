...
const sections: SettingsNavSection[] = [
  ...
  {
    id: 'servers',
    title: 'Remote LogicMantra Servers',
    description: 'Pair remote LogicMantra runtimes.',
    icon: Settings,
    searchEntries: [{ title: 'Remote LogicMantra Servers' }],
    group: 'remote'
  },
  {
    id: 'ssh',
    ...
    const integrationSections: SettingsNavSection[] = [
      {
        id: 'linear',
        title: 'Linear',
        description: 'How Linear works in LogicMantra.',
        icon: Settings,
        searchEntries: [],
        group: 'capabilities'
      },
