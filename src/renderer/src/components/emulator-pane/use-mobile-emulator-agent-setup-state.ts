      ...
      if (skillInstalled) {
        toast.message(
          translate(
            ...
            'Skill is installed. Enable the LogicMantra CLI to finish setup.'
          )
        )
        return
      }
      if (cliReady) {
        toast.message(
          translate(
            ...
            'LogicMantra CLI is ready. Install the skill to finish setup.'
          )
        )
        return
      }
      ...
      if (mountedRef.current && isOrcaCliAvailableOnPath(next)) {
        toast.success(
          translate(
            ...
            'Registered the LogicMantra CLI in PATH.'
          )
        )
      }
    } finally {
