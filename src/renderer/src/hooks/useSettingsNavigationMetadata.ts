...
export function buildSettingsNavigationMetadata({
  ...
  return [
    ...
    },
    {
      id: 'baton',
      title: translate(
        'auto.hooks.useSettingsNavigationMetadata.batonTitle',
        'Baton'
      ),
      description: translate(
        'auto.hooks.useSettingsNavigationMetadata.batonDescription',
      ...
      : []),
    {
      ...
      description: translate(
        ...
        'Finish the onboarding checklist for core LogicMantra workflows.'
      ),
      ...
      ? [
          {
            ...
            description: translate(
              ...
              'Install and manage experimental LogicMantra plugins.'
            ),
            icon: Blocks,
