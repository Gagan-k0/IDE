        ...
        }),
    {
      ...
      description: worktreeName
        ? translate(
            ...
            'Workspace "{{value0}}" was created from {{value1}}, but LogicMantra could not fast-forward local {{value2}}. {{value3}}',
            {
              value0: worktreeName,
        ...
        : translate(
            ...
            'Workspace created from {{value0}}, but LogicMantra could not fast-forward local {{value1}}. {{value2}}',
  ...
  toast.error(
    ...
    ),
    {
      ...
      description: translate(
        ...
        'Workspaces are unavailable on a mobile-scope pairing. Reconnect using the browser access link from Settings → Runtime Environments → Share this LogicMantra server.'
      )
    }
  )
  return true
