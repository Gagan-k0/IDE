...
describe('createEditorSlice activateMarkdownLink', () => {
  ...
  it('opens in-worktree file links in LogicMantra', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs inside the worktree in LogicMantra', async () => {
    const store = createEditorStore()
  ...
  it('opens explicit file URLs outside the worktree in LogicMantra after authorizing them', async () => {
    const store = createEditorStore()
