...
describe('removeWorktree cascade', () => {
  ...
  it.each([
    ...
    'Remote LogicMantra runtime closed the connection.',
    'Timed out waiting for the remote LogicMantra runtime to respond.'
  ])(
  ...
  it('offers force delete for orphaned LogicMantra worktree directories', async () => {
    const store = createTestStore()
    const worktreeId = 'repo1::/path/wt1'
