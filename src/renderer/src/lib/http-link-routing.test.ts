...
describe('openHttpLink', () => {
  it('routes into LogicMantra when openLinksInApp is on and a worktree is known', () => {
  ...
  it('routes floating workspace links into LogicMantra without changing the active repo worktree', () => {
    storeState.settings = { openLinksInApp: true }
  ...
  it('forceInApp opens a local link in LogicMantra when the setting is off', () => {
    storeState.settings = { openLinksInApp: false }
  ...
  it('does not force a remote link into the LogicMantra browser', () => {
    storeState.settings = { openLinksInApp: false }
...
describe('openHttpLink modifier routing', () => {
  it('forces the system browser when inverting is off and links open in LogicMantra', () => {
  ...
  it('opens in LogicMantra when inverting is on and links open externally', () => {
  ...
  it('opens in the system browser when inverting is on and links open in LogicMantra', () => {
  ...
  it('never routes a remote source into LogicMantra even when inverting', () => {
    storeState.settings = { openLinksInApp: false, openLinksInAppModifierInverts: true }
