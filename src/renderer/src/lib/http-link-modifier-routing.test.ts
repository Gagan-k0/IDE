...
describe('resolveModifierRouting', () => {
  ...
  it('still reaches the system browser when inverting and links open in LogicMantra', () => {
  ...
  it('reaches LogicMantra when inverting and links open in the system browser', () => {
...
describe('modifier routing across link source owners', () => {
  ...
  it('still lets the inverting modifier pull a local link into LogicMantra', () => {
  ...
  it('lets an inverting modifier reach LogicMantra on the owning runtime', () => {
    storeState.settings = {
